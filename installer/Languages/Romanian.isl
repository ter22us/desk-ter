; Modified for Desk Ter, 2026-09-11: UTF-8 BOM, updated message keys.
; Original translation and attribution retained; see Inno-Setup-License.txt and PROVENIENTA.md.
...
; Desk Ter additions for Inno Setup 6.7.3
DownloadingLabel2=Se descarcă fișierele...
ExtractingLabel=Se extrag fișierele...
ButtonStopExtraction=&Oprește extragerea
StopExtraction=Sigur vrei să oprești extragerea?
ErrorExtractionAborted=Extragerea a fost oprită
ErrorExtractionFailed=Extragerea a eșuat: %1
ArchiveIncorrectPassword=Parola este incorectă
ArchiveIsCorrupted=Arhiva este deteriorată
ArchiveUnsupportedFormat=Formatul arhivei nu este acceptat
RetryCancelSelectAction=Selectează acțiunea
RetryCancelRetry=Î&ncearcă din nou
RetryCancelCancel=Anulează
...
VerificationKeyNotFound=Fișierul de semnătură "%1" folosește o cheie necunoscută
...
VerificationFileHashIncorrect=Hashul fișierului este incorect
ErrorDownloading=A apărut o eroare la descărcarea unui fișier:
ErrorExtracting=A apărut o eroare la extragerea unei arhive:
